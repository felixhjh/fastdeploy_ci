...
class TestMobileNetV3_small_x0_35_ssldTest(CaseBase):
    def setup_class(self):
        self.util = FastdeployTest(data_dir_name="imagenet", model_dir_name="MobileNetV3_large_x1_0_ssld_infer/", model_name="mobilenetv3_large_x1_0_ssld", csv_path="./infer_result/mobilenetv3_large_x1_0_ssld_result.csv")
