...
def parse_arguments():
    ...
    parser.add_argument(
        "--gt_path", type=str,required=True, help="Path of ground truth result path.")
    parser.add_argument(
        "--result_path", type=str, required=True, help="Path of inference result path.")
    parser.add_argument(
...
def write2file(error_file):
    with open(error_file, "w+") as f:
        import os
        py_version = os.popen('python -V').read().strip()
